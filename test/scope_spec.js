...
describe("Scope", function () {
    ...
    describe("digest", function () {
        ...
        it("executes $evalAysnc'ed functions even when not dirty", function () {
            scope.aValue = [1, 2, 3];
        ...
        it("eventually halts $evalAsyncs added by watchhes", function () {
            scope.aValue = [1, 2, 3];
        ...
        it("cancels and flushes $applyAsync if digestd first", function (done) {
            scope.counter = 0;
            scope.$watch(function (scope) {
                scope.counter++;
                return scope.aValue;
    ...
    describe("$watchGroup", function () {
        ...
        it("Deregistered listenerFns", function () {
            var counter = 0;
    ...
    describe("inheritance", function () {
        ...
        it("keep a record of its children", function () {
            var parent = new Scope();
        ...
        it("$evalAsync from root on $apply when isolated", function (done) {
            var parent = new Scope();
            var child = parent.$new(true);
            var child2 = child.$new();
        ...
        it("executes $evalAsync functions on isolated scope", function (done) {
            var parent = new Scope();
            var child = parent.$new(true);
    ...
    describe("$watchCollection", function () {
        ...
        it("notices an item replaced from an array", function () {
            scope.arr = [1, 2, 3];
            scope.counter = 0;
        ...
        it("notices reorder from an array", function () {
            scope.arr = [5, 2, 3];
            scope.counter = 0;
        ...
        it("does not fail in NaNs", function () {
            scope.arr = [2, NaN, 3];
            scope.counter = 0;
    ...
    describe("Events", function () {
        ...
        _.forEach(['$emit', '$broadcast'], function (method) {
            ...
            it("passes additional arguments to listeners on " + method, function () {
                ...
                scope[method]('someEvent', 'and', ['additional', 'argument'], '...');

                expect(listener.calls.mostRecent().args[1]).toEqual('and');
                expect(listener.calls.mostRecent().args[2]).toEqual(['additional', 'argument']);
        ...
        it("sets currentScope to null after the propagation on $emit", function () {
            var event;
        ...
        it("sets currentScope to null after the propagation on $broadcast", function () {
            var event;
            var scopeListener = function (evt) {
                event = evt;
            };
